...
try {
  ...
  await app.getByRole('link', { name: /Ôn tập/ }).first().click();
  ...
  await app.getByRole('link', { name: 'Góc học hôm nay', exact: true }).click();
  ...
  await app.getByRole('link', { name: /^Ôn tập/ }).click();
  ...
  await app.getByRole('link', { name: 'Cài đặt & dữ liệu', exact: true }).click();
